...
{
    /// <summary>
    /// Interaction logic for UploadApprovalDocumentWindow.xaml
    /// </summary>
    public partial class UploadApprovalDocumentProductWindow : Window
    {
        public UploadApprovalDocumentProductWindow()
        {
            InitializeComponent();
        }
